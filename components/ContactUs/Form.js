                ...
                <section className="contact-area ptb-100">
                    <div className="container">
                        <div className="section-title">
                            ...
                            <p>Cualquier cosa que desees saber sobre Disu. Estaremos encantados de ayudarte.</p>
                        </div>

                        <div className="row h-100 justify-content-center align-items-center">
                            <div className="col-lg-6 col-md-12">
                                <img src='/images/disu/banner-disu.png' alt="image" />
                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12 col-md-6">
                                            <div className="select-box">
                                                <select className="form-control" onChange={this.subjectChangeHandler}>
                                                    <option value="0">Subject</option>
                                                    <option value="1">Trade Volume</option>
                                                    <option value="2">Supplier Rating</option>
                                                    <option value="0">Delivery Time</option>
                                                    <option value="3">Financing Options</option>
